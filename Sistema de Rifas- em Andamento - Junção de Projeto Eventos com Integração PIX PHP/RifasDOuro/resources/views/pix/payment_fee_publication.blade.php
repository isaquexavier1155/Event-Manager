...
<!-- Conteudo Central -->
    <div class="conteudo-central">
        <div class="centralized-content"><br>
            <h3>Pagamento da taxa de publicação</h3><br><br><br>
            <h5>Ao realizar o pagamento </h5>
            <h5>você será redirecionado para a próxima página</h5>
        </div>
        
        <div class="centralized-content2">
            <strong id="arrecadacao">Arrecadação Estimada: R$ + {{ $arrecadacaoEstimada }}</strong>
            <br>
            <strong id="taxapublicacao">Taxa de publicação: R$ - {{ $taxaPublicacaoString }}</strong>
            <br><br>
